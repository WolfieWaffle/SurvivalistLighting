...
public class ConfigHandler {
	...
	public static int oilCanFuel = 360000;
	public static int lanternFuel = 36000;
	public static int torchBurnoutChance = 10;
	public static int torchBurnout = 72000; //72000
	...
	public static void init() {
		...
		comment = "The amount of ticks the oilcan 'stores' for a lantern.";
		oilCanFuel = loadInt("lantern.oilCanFuel", comment, oilCanFuel);

		comment = "The amount of ticks a lantern stays lit for.";
		lanternFuel = loadInt("lantern.lanternFuel", comment, lanternFuel);

		comment = "The chance on random tick to extinguish this torch. The other method does not seem to work currently.";
	...
	public static void printConfigInfo() {
		SurvivalistLighting.logger.info("Torch burnout rate: " + ConfigHandler.torchBurnout + " ticks (" + ConfigHandler.torchBurnout / 1200 + " minutes)");

		if (ConfigHandler.handheldLightEnabled == true) {
			SurvivalistLighting.logger.info("Handheld light sources are enabled.");
		} else {
			SurvivalistLighting.logger.info("Handheld light sources are disabled.");
		}
	}
	...
	public static class ChangeListener {
		...
		public void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent eventArgs) {
			if (eventArgs.getModID().equals(SurvivalistLighting.MODID)) {
				init();
			}
		}
	}
